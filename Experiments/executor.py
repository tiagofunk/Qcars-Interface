...
if __name__ == "__main__":
    ...
    args = files
    args = create_all_combinatitions( args, "--strategy", ["mpr"] )
    args = create_all_combinatitions( args, "--sizePopulation", ["10"] )
    args = create_all_combinatitions( args, "--elite", ["0.4"] )
    args = create_all_combinatitions( args, "--limitIterations", ["10"] )
    args = create_all_combinatitions( args, "--sizePlasmideo", ["0.5"] )
    args = create_all_combinatitions( args, "--cross", ["0.85"] )
    args = create_all_combinatitions( args, "--selectionStrategy", ["a"] )
    args = create_all_combinatitions( args, "--intermediaryStrategy", ["stef"] )
